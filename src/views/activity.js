...
/* Trang "Duyệt Hợp đồng" riêng của HCNS từng nằm ở đây — nay bỏ: Console HCNS đã gộp báo giá +
 * hợp đồng + hồ sơ thầu vào đúng một danh sách "Hồ sơ cần duyệt" (views/console.js), không cần
 * mượn route của Lịch & Hoạt động để làm màn duyệt thứ hai nữa. */
